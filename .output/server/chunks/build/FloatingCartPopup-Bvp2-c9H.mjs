import { defineStore, storeToRefs } from 'file://C:/Users/ACER/Documents/yo/memora/node_modules/pinia/dist/pinia.prod.cjs';
import __nuxt_component_1 from './index-DwcbW_k1.mjs';
import { defineComponent, ref, unref, useSSRContext } from 'file://C:/Users/ACER/Documents/yo/memora/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderTeleport, ssrRenderList, ssrRenderAttr, ssrInterpolate } from 'file://C:/Users/ACER/Documents/yo/memora/node_modules/vue/server-renderer/index.mjs';
...
const useEssenceStore = defineStore("memora-essences", {
  state: () => ({
    essences: [
      ...
      createEssence("crema-de-limon", "Crema de lim\xF3n", "Goutmant"),
      ...
      createEssence("dulce-tentacion", "Dulce tentaci\xF3n", "Frutales"),
      createEssence("fruto-salvaje", "Fruto salvaje", "Frutales"),
      createEssence("cherry-amour", "Cherry Amour", "Frutales"),
      createEssence("limon-siciliano", "Lim\xF3n Siciliano", "Frutales"),
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(isOpen)) {
          ...
          if (!unref(carrito).length) {
            ...
            _push2(`</div><p class="mt-6 text-3xl font-semibold text-white">Carrito vac\xEDo</p></div>`);
          } else {
...
export { UseDataEstore as U, _sfc_main as _, useEssenceStore as u };
//# sourceMappingURL=FloatingCartPopup-Bvp2-c9H.mjs.map
